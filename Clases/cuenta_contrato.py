class CuentaContrato:
    ...
    def SetDatosGenerales(self):
        ...
        self.sap.session.findById("wnd[0]/usr/tabsTABSTRIP1/tabpBUSCR01/ssubGENSUB:SAPLBUSS:7005/subA03P04:SAPLES35:0320/ctxtSI_FKKVKPR-REGIOGR_CA_B").text = self.estrRegion
