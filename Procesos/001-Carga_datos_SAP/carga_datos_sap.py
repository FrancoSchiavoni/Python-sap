...
# Se abre el archivo de registro de errores en modo de escritura
...
# Escribe la cantidad de errores en el archivo de resultados
resultados.append({'Total de errores': x})
# Escribe la cantidad de errores en el archivo de registro de errores
error_log_file.write(f"Total de errores registrados: {x}\n")
# Finaliza el proceso y cierra el archivo de registro de errores
